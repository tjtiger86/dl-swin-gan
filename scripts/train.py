...
from dl_cs.fileio import folder_param as fp
...
class LitUnrolled(pl.LightningModule):
    ...
    def compute_metrics(self, prediction, target, is_training=True):
        ...
        if self.config.MODEL.RECON_LOSS.NAME == "complex_vggloss":
            metrics[f'{tag}/complex_vggloss'] = metric.vggloss(mTarget, mPrediction)
...
if __name__ == '__main__':
    ...
    #config.OUTPUT_DIR = fp.parameter_to_folder(config)
